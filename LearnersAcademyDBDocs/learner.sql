...
VALUES (STUDENTS_SEQ.nextval, 'John Doe'|| STUDENTS_SEQ.nextval , STUDENT_CLASSES_SEQ.nextval, 12, 'M', 82, 74, 56, 89, 48, 90);

INSERT INTO students (student_id, student_name, class_id,  age, gender ,maths_grade,  english_grade, social_science_grade, art_grade, science_grade, final_grade) 
VALUES (STUDENTS_SEQ.currval, 'Mary Jane'|| STUDENTS_SEQ.nextval , STUDENT_CLASSES_SEQ.currval, 14, 'F', 68, 98, 54, 28, 18, 74);

INSERT INTO students (student_id, student_name, class_id,  age, gender ,maths_grade,  english_grade, social_science_grade, art_grade, science_grade, final_grade) 
VALUES (STUDENTS_SEQ.currval, 'Sachin'|| STUDENTS_SEQ.nextval , STUDENT_CLASSES_SEQ.currval, 11, 'M', 45 ,64, 89, 74, 65, 80);

INSERT INTO students (student_id, student_name, class_id,  age, gender ,maths_grade,  english_grade, social_science_grade, art_grade, science_grade, final_grade) 
VALUES (STUDENTS_SEQ.currval, 'Gaurav'|| STUDENTS_SEQ.nextval , STUDENT_CLASSES_SEQ.currval, 16, 'M', 79, 14, 11, 55, 77, 87);

INSERT INTO students (student_id, student_name, class_id,  age, gender ,maths_grade,  english_grade, social_science_grade, art_grade, science_grade, final_grade) 
VALUES (STUDENTS_SEQ.currval, 'Smith'|| STUDENTS_SEQ.nextval , STUDENT_CLASSES_SEQ.currval, 12, 'M', 52, 25, 64, 56, 87, 48);
